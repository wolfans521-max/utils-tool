...
type C98 struct {
	...
	TitleStruct         []*C98TitleStruct `json:"title_struct,omitempty"`         // 标题结构
...
// NewCard98 创建Card98实例
func NewCard98() *C98 {
	return &C98{BaseItem: BaseItem{Base: Base{CardType: 98}}}
}
