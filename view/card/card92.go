...
type C92 struct {
	...
	TitleStruct         []*C92TitleStruct `json:"title_struct,omitempty"`         // 标题结构
...
// NewCard92 创建Card92实例
func NewCard92() *C92 {
	return &C92{BaseItem: BaseItem{Base: Base{CardType: 92}}}
}
